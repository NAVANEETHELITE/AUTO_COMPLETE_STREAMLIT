...
- Lazy of typing the whole sentence?? Use my AUTO COMPLETION app. But the output won't be that accurate LOL xD. My model was trained on just 3500 lines of text. (just to learn the model building and deployment)
